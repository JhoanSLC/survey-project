...
public class CategoriesCatalogRepository implements CategoriesCatalogService {
    ...
    public void createCategories(CategoriesCatalog category) {
        String createQuery = "INSERT INTO categoriesCatalog(createdAt,updatedAt,name) values (?,?,?)";
        ...
        try (PreparedStatement ps = con.prepareStatement(createQuery)){
            ...
            ps.setTimestamp(1, Timestamp.valueOf(category.getCreatedAt()));
            ps.setTimestamp(2, Timestamp.valueOf(category.getUpdatedAt()));
